% This code calculates the acoustic radiation force on a spherical
...
function Yst=hasegawa79_rad_force_fct(xeval,MASSsc,LENGTHsc,TIMEsc)
...
% Water properties
rholiq=1000*LENGTHsc^2/(MASSsc)*TIMEsc; % Liquid density
cliq=1480/(LENGTHsc*TIMEsc); % Liquid speed of sound
