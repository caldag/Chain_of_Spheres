...
% of nickel in a standing field in water as described in:
%
...
clearvars;
comdata=load('w_ni_helmirsw_lamb100um.txt'); % Results from COMSOL simulations
...
for jj=1:length(hel_com_arf) % Will do the chain-of-spheres computation for each simulation
