...
close all;
load('w_ni_Nsw_data.mat'); % Data for the parameter sweep on number of helical rotations
...
load('w_ni_helmirsw_data.mat'); % Data for the parameter sweep on the minor radius
hel_mir_com_arf=hel_com_arf;
hel_mir_has_arf=hel_has_arf;
x_mir_data=hel_mir_list.*2;
hel_mir_err=errv;

load('w_ni_helmarsw_data.mat'); % Data for the parameter sweep on the major radius
...
load('w_ni_hellengthsw_data.mat'); % Data for the parameter sweep on the helix wavelength
